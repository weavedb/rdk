  ...
  // sdk/contracts/weavedb-bpt/lib/base.js
  var require_base = __commonJS({
    "sdk/contracts/weavedb-bpt/lib/base.js"(exports, module) {
  ...
  var require_utils = __commonJS({
    "sdk/contracts/weavedb-bpt/lib/utils.js"(exports, module) {
      ...
      var _parse = async (state, action, _func, signer, salt, contractErr = true, SmartWeave2, kvs, type, fn2) => {
        let func;
        if (!isNil(_func))
          func = _func.split(":")[0];
        const { data } = state;
        ...
        if (includes(func)([
          ...
          if (func === "add") {
            ...
            path.push(id);
            await fn2.addNewDoc(id, SmartWeave2, state, kvs);
